...
lib.mkIf config.programs.tint2.enable {
  programs.tint2.extraConfig = ''
    ...
    # time1_font = JetBrains Mono Regular 8
    # time2_font = JetBrains Mono Regular 8
    # time2_format = %A %d %B
